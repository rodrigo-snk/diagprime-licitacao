...
/**
 * Lançamento de pedidos feito por linhas selecionadas
 * Alexandre decidiu fazer de outra forma, verificando todos os registros a liberar na tela
 */
public class LancaPedidos_OLD implements AcaoRotinaJava {

    final private BigDecimal codUsuLogado = AuthenticationInfo.getCurrent().getUserID();
